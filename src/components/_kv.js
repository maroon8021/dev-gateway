...
const _KV = () => {
  ...
  return (
    <section className="_kv">
      <div className="_kv-blue-layer" ref={kvLayerDom} />
      <div
        className="_kv-image-layer"
        ref={kvDom}
        style={{ backgroundImage: `url(${kvImage01})` }}
      />

      <div className="_kv-wrapper">
        <h2 className="title is-1">
          <span className="_kv-first-title" ref={title1}>
            天職を
          </span>
          <span
            className="_kv-first-title"
            ref={title2}
            dangerouslySetInnerHTML={{ __html: "&nbsp;いま、" }}
          />
          <br />
          <span className="_kv-first-title spacer" ref={title3}>
            はじめよう
          </span>
          {/*<span
